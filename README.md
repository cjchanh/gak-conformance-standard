...
| Artifact | Path |
|---|---|
| **The standard (normative)** — 7-primitive thesis, 3 profiles, 13 clauses, receipt + digest schema, adapter contract, worked third-party example | [`v1/spec.md`](v1/spec.md) |
